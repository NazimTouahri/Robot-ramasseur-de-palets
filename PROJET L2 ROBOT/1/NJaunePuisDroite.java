...
/**
 * Classe pour aller chercher les palets en partant de la ligne Jaune avec le premier virage a droite
 * @author simon
 *
 */

public class NJaunePuisDroite {
...
/**
 * Permet d'aller chercher les palets en partant de la ligne Jaune avec le premier virage a droite
...
pilot.rotate(90); // tourne vers la ligne bleue

/////////////RAMASSAGE DES PALETS SUR LA LIGNE BLEUE/////////////////////
...
Motor.B.forward();
Motor.B.setSpeed(150);
while(!color2.IsBlue()) {Motor.B.forward();}
ev3.arreter1();
...
ev3.avancer1();
Delay.msDelay(50);
ev3.arreter1();  // depasse un petit peu le bleu
