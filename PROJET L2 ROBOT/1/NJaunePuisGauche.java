...
/**
 * Classe pour aller chercher les palets en partant de la ligne Jaune avec le premier virage a gauche
 * @author simon
 *
 */

public class NJaunePuisGauche {
...
/**
 * Permet d'aller chercher les palets en partant de la ligne Jaune avec le premier virage a gauche
 * Prend fin quand il n'y a plus de palets sur les intersections
 */
public static void ProjetJaunePuisGauche() {
...
Motor.A.forward();
Motor.A.setSpeed(150);
while(!color2.IsGreen()) {Motor.A.forward();}
ev3.arreter1();
...
ev3.avancer1();
Delay.msDelay(38);
ev3.arreter1();		// depasse un peu la ligne bleue
