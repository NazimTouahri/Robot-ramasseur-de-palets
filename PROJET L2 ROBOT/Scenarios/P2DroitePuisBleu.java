...
public class P2DroitePuisBleu {
	...
	public static void P2() {
		...
		ev3.avancer1();
		while(!color2.IsBlue()) {ev3.avancer1();} // avance jusqu'a la ligne bleue
		ev3.arreter1();
		 ...
		 */
			...
			ev3.avancer1();
			Delay.msDelay(38);  	// on depasse legerement la ligne bleue
			ev3.arreter1();
			 ...
			 */
			ev3.HorsLigne();
			while(!ultrasonic.TestUltrasonic2(0.25f))
			{
			...
			/*
			 * le robot va pivoter a 90 degré , il ira ensuite jusqu'a la ligne verte 
			 ...
			 */
				...
				pilot.rotate(90);		// il tourne a 90 degré vers la gauche
				ev3.avancer1();
				while(!color2.IsGreen()) {ev3.avancer1();} // il avance jusqu'au vert
				ev3.arreter1();
				ev3.avancer1();
				Delay.msDelay(38);		// il depasse un peu la ligne verte
				ev3.arreter1();
				...
				Motor.B.forward();
				Motor.B.setSpeed(150);
				while(!color2.IsGreen()) {Motor.B.forward();}		// il tourne jusq'au vert
				ev3.arreter1();
